...
function showProductNaviagtionLinks() {
 var products = [  "Flai", "Lyn", "Shape", "Zet", "RoundAbout", "Fju", "Raft", "Plank", "Check", "Scoop_table", "Scoop_chair",
                  "Bubka", "Hoeninger", "PinaSideTable", "tome", "TampLable", "CherryTable", "Keep", "Cherry", "Konichiwa", "Industrial",
                  "Cap", "PinaTableLamp", "Flachmann", "Lop", "Candleblocks", "Luna", "Bulb", "Bonfire", "hopperboxes"],
